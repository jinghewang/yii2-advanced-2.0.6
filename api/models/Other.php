...
class Other extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'contr_id' => 'Contr ID',
            'groupcorp' => '组团社信息  corp旅行社名称、corpCode 旅行社业务经营许可证编号 、scope经营范围
            ...
            zip 邮编
            mail 电子信箱',
            'pay' => '旅游费用支付方式及时间  payEachAdult 成人单价、payEachChild儿童单间、payTravel合计花费 、payDeadline旅游费用交纳期限、payType旅游费用交纳方式',
